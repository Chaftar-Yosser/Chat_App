...
class Conversation extends React.Component {
    render() {
        return (
            <NavLink to={"/conversation/" + this.props.conversation.conversationId } className="list-group-item list-group-item-action rounded-0">
                <div className="media">
                    ...
                    <div className="media-body ml-4">
                        <div className="d-flex align-items-center justify-content-between mb-1">
                            ...
                            <small
                                className="small font-weight-bold">{new Date(this.props.conversation.createdAt).toLocaleDateString()}
                            </small>
                        </div>
